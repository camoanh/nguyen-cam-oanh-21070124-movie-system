...
class CinemasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cinema" do
    assert_difference("Cinema.count") do
      post cinemas_url, params: { cinema: { Number: @cinema.Number, Room: @cinema.Room, Row: @cinema.Row } }
    end
  ...
  test "should update cinema" do
    patch cinema_url(@cinema), params: { cinema: { Number: @cinema.Number, Room: @cinema.Room, Row: @cinema.Row } }
