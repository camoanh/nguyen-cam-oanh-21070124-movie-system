...
class ProducersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create producer" do
    assert_difference("Producer.count") do
      post producers_url, params: { producer: { Actor: @producer.Actor, Director: @producer.Director, Writer: @producer.Writer } }
    end
  ...
  test "should update producer" do
    patch producer_url(@producer), params: { producer: { Actor: @producer.Actor, Director: @producer.Director, Writer: @producer.Writer } }
